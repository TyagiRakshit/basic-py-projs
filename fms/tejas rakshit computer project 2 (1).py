data import mysql.connector as mc
...
def createtable():
 ...
 mcur.execute(q7)
 q8="create table if not exists Snacks(Srno int(2) PRIMARY KEY, Type varchar(15), Price varchar(3))"
 mcur.execute(q8) 
 q13="create table if not exists forder(Srno int(2) PRIMARY KEY, Name varchar(20), Item varchar(15))"
 mcur.execute(q13)
...
def addpassenger():
 ...
 if wtbag<wtallowed:
  ...
  q9="insert into passengers value('{}',{},{})".format(name,age,seat_no,destination,nobag,wtbag)
  mcur.execute(q9)
  mdb.commit()
  print("executed")
def food():
